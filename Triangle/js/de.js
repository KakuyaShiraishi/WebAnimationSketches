...
function createDeuce() {
	momentDeuce = new PIXI.Container();
	momentGroup.addChild(momentDeuce);
	
	var loader = new PIXI.loaders.Loader();
	loader.add("img/deuce/lightning-red.png");
	loader.add("img/deuce/lightning-blue.png");
	loader.add("img/deuce/circle-red.png");
	loader.add("img/deuce/circle-blue.png");
	loader.add("img/deuce/streak-red.png");
	loader.add("img/deuce/streak-blue.png");
	loader.once('complete',onAssetsLoaded);
	loader.load();
	
	function onAssetsLoaded() {
		
		deuceParticleContainer = new PIXI.Container();
		...
		if (matchVizViewConfig.isWebGL) deuceScoreSquare1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceScoreSquare2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceBullet.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceDivider1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceDivider2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 3; i++) {
			...
			if (matchVizViewConfig.isWebGL) deuceRect1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
			...
			if (matchVizViewConfig.isWebGL) deuceRect2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceLightning1_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceLightning1_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceLightning2_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceLightning2_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceStreak1_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceStreak1_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceStreak2_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) deuceStreak2_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 20; i++) {
			...
			if (matchVizViewConfig.isWebGL) deuceParticle.blendMode = PIXI.BLEND_MODES.MULTIPLY;
			momentDeuce.addChild(deuceParticle);
			deuceExplosionArray.push(deuceParticle);
		}
		
		deuceScore1 = new PIXI.Text("40", { font: "200px Knockout47", fill: "#ffffff", padding: 20 });
		deuceScore1.position.x = 0;
		deuceScore1.position.y = 0;
		deuceScore1.anchor.x = 0.5;
		deuceScore1.anchor.y = 0.35;
		momentDeuce.addChild(deuceScore1);
		
		deuceScore2 = new PIXI.Text("40", { font: "200px Knockout47", fill: "#ffffff", padding: 20 });
		deuceScore2.position.x = 0;
		deuceScore2.position.y = 0;
		deuceScore2.anchor.x = 0.5;
		deuceScore2.anchor.y = 0.35;
		momentDeuce.addChild(deuceScore2);
		
		deuceTitle = new PIXI.Text("DEUCE", { font: "70px Knockout47", fill: "#ffffff", padding: 15 });
		deuceTitle.position.x = 0;
		deuceTitle.position.y = 0;
		deuceTitle.anchor.x = 0.5;
		deuceTitle.anchor.y = 0.35;
...
function explodeDeuce() {
	...
	deuceAnimationIn.add(TweenMax.fromTo( deuceTitle, 1.5,{ x: 0, y: 0, scaleX: 0, scaleY: 0 },{ x: 0, y: 0, scaleX: 1, scaleY: 1, ease: Elastic.easeOut }), 2.5);
	deuceAnimationIn.add(TweenMax.fromTo( deuceTitle, 1.5,{ alpha: 0 },{ alpha: 1, ease: Expo.easeOut }), 2.5);
